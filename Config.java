...
public class Config {
    ...
    public static class GameServerConfig extends ServerConfig {
        public String id = "Mukey_test";
        public String name = "Mukey";
        public String description = "A Mukey server";
    ...
    public static class WelcomeMail {
        ...
        public WelcomeMail() {
            this.title = "Welcome to a Mukey server";
            this.sender = "Server";
            this.content = "Welcome to Mukey！";
